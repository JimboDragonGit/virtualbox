      ...
      when 'debian'
        ...
        if platform?('ubuntu')
          ...
          when '24.04'
            ...
            packages.append 'libopengl0', 'libqt6waylandclient6', 'libqt6waylandcompositor6', 'libqt6waylandeglclienthwintegration6', 'libqt6waylandeglcompositorhwintegration6', 'libqt6wlshellintegration6'
